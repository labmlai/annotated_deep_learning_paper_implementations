...
from labml_nn.distillation.large import Model as LargeModel, Configs as LargeConfigs
from labml_nn.distillation.small import Model as SmallModel
...
def main(run_uuid: str, checkpoint: int):
    ...
    # Create experiment
    experiment.create(name='cifar10', comment='distillation')
